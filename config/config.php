...
return [
    ...
    'lang_switch_on' => true,
    // 默认全局过滤方法 用逗号分隔多个
    'default_filter' => 'strip_tags,htmlspecialchars', //strip_tags,htmlspecialchars
    // 默认语言
    'default_lang' => 'zh-cn',
    // 应用类库后缀
    'class_suffix' => false,
    ...
    'fastadmin' => [
        //是否开启前台会员中心
        'usercenter' => true,
        // 应用登录模式 1 手机号码验证 + 密码 + 短信验证码登录 2 手机号码 + 密码 + 图片验证码
        'admin_login_mode' => Env::get('app.admin_login_mode', '2'),
        //登录验证码
        'login_captcha' => true,
        //登录失败超过10次则1天后重试
    ...
    'database' => [
        ...
        // 数据库名
        'database'        => Env::get('database.database', 'straysh_admin'),
        // 用户名
